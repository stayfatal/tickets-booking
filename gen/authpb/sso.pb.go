...
type RegisterRequest struct {
	...
	IsConsultant bool   `protobuf:"varint,4,opt,name=is_consultant,json=isConsultant,proto3" json:"is_consultant,omitempty"`
}
...
func (x *RegisterRequest) GetIsConsultant() bool {
	if x != nil {
		return x.IsConsultant
	}
	return false
}
...
var file_sso_proto_rawDesc = []byte{
	...
	0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x12, 0x23, 0x0a, 0x0d, 0x69, 0x73, 0x5f,
	0x63, 0x6f, 0x6e, 0x73, 0x75, 0x6c, 0x74, 0x61, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x0c, 0x69, 0x73, 0x43, 0x6f, 0x6e, 0x73, 0x75, 0x6c, 0x74, 0x61, 0x6e, 0x74, 0x22, 0x3e,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0x7d, 0x0a,
	0x0e, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	0x39, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x12, 0x14, 0x2e, 0x73, 0x73,
	...
	0x67, 0x65, 0x6e, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x70, 0x62, 0x3b, 0x61, 0x75, 0x74, 0x68, 0x70,
...
var file_sso_proto_depIdxs = []int32{
	0, // 0: sso.Authentication.Register:input_type -> sso.RegisterRequest
	2, // 1: sso.Authentication.Login:input_type -> sso.LoginRequest
	1, // 2: sso.Authentication.Register:output_type -> sso.RegisterResponse
	3, // 3: sso.Authentication.Login:output_type -> sso.LoginResponse
